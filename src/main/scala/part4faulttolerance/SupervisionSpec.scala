...
class SupervisionSpec extends TestKit(ActorSystem("SupervisionSpec"))
  ...
  "A supervisor" should {
    "resume its child in case of a minor fault" in {
      ...
      child ! "I am learning Akka"
      child ! Report
      expectMsg(4)

      child ! "Akka is awesome because it helps me to think in a whole new way"
      child ! Report
      expectMsg(4) // after resuming the state of the actor should not change
    }
  ...
  class FussyWordCounter extends Actor {
    ...
    override def receive: Receive = {
      ...
      case sentence: String =>
        ...
        else wordCount += sentence.split(" ").length
